...
global_schema=pd.read_csv('https://dbgroup.ing.unimore.it/SIWS/DataIntegration/4Movie/Movie3.csv').astype(str)
...
SOURCES={}
SOURCES['S1'] = pd.read_csv('https://dbgroup.ing.unimore.it/SIWS/DataIntegration/4Movie/Movie0.csv').astype(str)
SOURCES['S2'] = pd.read_csv('https://dbgroup.ing.unimore.it/SIWS/DataIntegration/4Movie/Movie1.csv').astype(str)
SOURCES['S3'] = pd.read_csv('https://dbgroup.ing.unimore.it/SIWS/DataIntegration/4Movie/Movie2.csv').astype(str)
...
for sim_methods in sim_combinations:
    ...
    gold_standard = pd.read_csv('https://dbgroup.ing.unimore.it/SIWS/DataIntegration/4Movie/GoldStandard3MovieGS.csv').astype(str)
