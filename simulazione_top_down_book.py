...
# local schemas
SOURCES={}
SOURCES['S1'] = pd.read_csv('http://dbgroup.ing.unimore.it/SIWS/DataIntegration/Esempi/EsempioBook/BookA1.csv').astype(str)
SOURCES['S2'] = pd.read_csv('http://dbgroup.ing.unimore.it/SIWS/DataIntegration/Esempi/EsempioBook/BookB1.csv').astype(str)
SOURCES['S3'] = pd.read_csv('http://dbgroup.ing.unimore.it/SIWS/DataIntegration/Esempi/EsempioBook/BookC1.csv').astype(str)
...
for sim_methods in sim_combinations:
    ...
    gold_standard = pd.read_csv('http://dbgroup.ing.unimore.it/SIWS/DataIntegration/Esempi/EsempioBook/GS_1_1_A.csv').astype(str)
